...
const TrialModal = ({
  ...
  return (
    <>
      ...
      <div
        data-trial-modal
        className={`fixed top-[5vh] left-1/2 -translate-x-1/2 w-[400px] max-w-[94vw] max-h-[90vh]
          bg-gradient-to-b from-white to-[#F8FAFC] rounded-3xl shadow-2xl p-4 overflow-hidden
      ...
      >
        ...
        {/* Header */}
        <div className="text-center relative z-[1] mb-2">
          ...
          <div className="inline-flex items-center gap-1.5 px-3.5 py-1.5 bg-gradient-to-r from-amber-400 to-amber-500
            rounded-full text-xs font-bold text-gray-800 uppercase tracking-wide mb-2 shadow-md shadow-amber-500/30">
            <Crown size={12} />
            <span>Premium</span>
          </div>

          <h2 className="text-2xl font-extrabold text-[#0B1120] tracking-tight leading-tight mb-1">
            {trialMessage.title}
          </h2>
        ...
        {/* Features */}
        <div className="relative z-[1] bg-gray-50 rounded-2xl p-3 mb-1">
        ...
        <div className="relative z-[1] text-center">
          <button
            className={`w-full py-3 px-7 rounded-xl text-base font-bold text-white
          ...
          {!isExpired && (
            <button
              className="mt-1 px-5 py-2 text-sm font-semibold text-gray-500 hover:text-gray-700
