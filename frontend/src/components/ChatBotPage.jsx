...
const ChatBotPage = () => {
  ...
  const botAvatar = chatbotGif;

  // ====== INPUT BAR COMPONENT ======
  const renderInputBar = () => (
    <div className={`border-t px-4 py-3 ${isDarkMode ? "" : "border-slate-200 bg-white"}`}>
        ...
        <form onSubmit={sendMessage}>
          <div className={`flex items-end gap-2 rounded-2xl border-2 px-3 py-2 transition-colors ${
            ...
            <input
              ...
              className={`flex-1 bg-transparent text-sm py-2 ${isDarkMode ? "text-white placeholder-slate-500" : "text-[#0B1120] placeholder-slate-400"}`}
              placeholder={
                ...
                <div className="space-y-2">
                  ...
                  <div className="flex gap-2">
                    <input
                      ...
                      className={`flex-1 px-3 py-2 rounded-lg border text-sm focus:border-[#00A0E3] ${isDarkMode ? "bg-slate-700 border-slate-600 text-white" : "bg-white border-slate-200"}`}
