    ...
    return (
      <div className="min-h-screen bg-[#F8FAFC] p-4 md:p-6">
        ...
        {showStudentDetailsModal && selectedStudentResult && (
          <div className="fixed inset-0 bg-black/50 backdrop-blur-sm flex items-center justify-center z-[1100] p-4" onClick={handleCloseStudentDetails}>
                  ...
                  {studentResults.map((result, index) => (
                    ...
                    >
                      ...
                      <td className="px-3 py-3">
                        <span className="font-medium text-[#0B1120]">{result.student_fullname || result.student_name || 'N/A'}</span>
                      </td>
